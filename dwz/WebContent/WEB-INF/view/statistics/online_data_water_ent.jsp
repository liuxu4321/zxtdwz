...
<!--
	function btnChoose()
	{
		var EnterpriseId = $('#ENTERPRISE_ID_W').val();
		var EnterpriseName = $('#ENTERPRISE_NAME_W').val()
		$.bringBack({id:EnterpriseId, wentName:EnterpriseName, wentId:EnterpriseId});
		ajaxRequestWaterJkd(EnterpriseId);
	}
	
	function trClick(obj)
	{
         $('#ENTERPRISE_NAME_W').val(obj.cells[0].innerText);
         $('#ENTERPRISE_ID_W').val(obj.cells[2].innerText);
	}
//-->
</script>
...
<div class="pageHeader">
	...
	<input type="hidden" name="ENTERPRISE_NAME_W" id="ENTERPRISE_NAME_W"/>
	<input type="hidden" name="ENTERPRISE_ID_W"  id="ENTERPRISE_ID_W"/>
	...
	<table class="table" layoutH="125" targetType="dialog" width="100%">
		<thead>
			<tr>
		...
		<tbody>
			<c:forEach var="onlineDataEnt" items="${page.result}">
				<tr  onclick="trClick(this);">
					...
					<td>
						<a class="btnSelect" href="javascript:$.bringBack({id:'${onlineDataEnt.ENTERPRISE_ID }', wentName:'${onlineDataEnt.ENTERPRISE_NAME }', wentId:'${onlineDataEnt.ENTERPRISE_ID }'});ajaxRequestWaterJkd('${onlineDataEnt.ENTERPRISE_ID }');" title="选择">选择</a>
					</td>
