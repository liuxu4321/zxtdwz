...
<div class="pageContent">
	...
	<div id="div_zxjcyqxx_s" class="pageFormContent">
		<form method="post" action="${context }/businessPlatfrom/zxjcyq/zxjcyqsz/add/water?navTabId=zxjcyqsz_${enIsFlag }&callbackType=closeCurrent" class="pageForm required-validate" onsubmit="return validateCallback(this,navTabAjaxDone)">
	...
	<div id="div_zxjcyqxx_q" class="pageFormContent" style="display:none;">
		<form method="post" action="${context }/businessPlatfrom/zxjcyq/zxjcyqsz/add/gas?navTabId=zxjcyqsz&callbackType=closeCurrent" class="pageForm required-validate" onsubmit="return validateCallback(this,navTabAjaxDone)">
			<input type="hidden" name="enterpriseId" value="${enterpriseId}">
			<div class="pageFormContent">
				<p>
					<label>在线监测仪器名称：</label>
