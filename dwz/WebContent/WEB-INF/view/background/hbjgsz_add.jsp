...
<div class="pageContent" layoutH="0">
	<form id="wrwEdit"  method="post" action="${context }/background/dic/hbjgsz/addAndSave?callbackType=closeCurrent" 
		...
		<div class="pageFormContent" layoutH="60">
			...
			<p>
				...
				<select name="parentId" class="required" >
					<c:forEach items="${environMap }" var="environ">
						<option value="${environ.key }">${environ.value }</option>
					</c:forEach>
				</select>
				<!-- <input name="environName" class="required" /> -->
			</p>
			<p>
				<label>电话号码：</label>
