...
<div class="pageContent" layoutH="0">
	<form method="post" action="${context }/background/dic/dlb/add/save?navTabId=dic_index&callbackType=closeCurrent"  class="pageForm required-validate" onsubmit="return iframeCallback(this, dialogAjaxDone);">
	...
	<table class="table_dlb">
		...
		<tr>
			<td>名称：</td>
			<td>
				<input type="text" name="className" class="required" maxlength="25"/>
			</td>
			<!-- 
			<td>是否有效：</td>
			<td>
