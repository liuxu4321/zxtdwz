...
<form method="post" action="${context}/management/book/update?navTabId=bookLiNav" class="pageForm required-validate" onsubmit="return validateCallback(this,navTabAjaxDone);">
	...
	<div class="pageFormContent" layoutH="56">
		...
		<a class="button" target="dialog" mask="true" width="800" height="400" href="${context}/management/chapter/add/${book.id}"><span>添加篇章</span></a>
