...
<form method="post" action="${context}/management/chapter/insert?navTabId=bookNav&callbackType=closeCurrent" enctype="multipart/form-data" class="pageForm required-validate" onsubmit="return iframeCallback(this, dialogAjaxDone);">
